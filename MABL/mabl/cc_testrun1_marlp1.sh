...
mainPy="/home/zwang182/MARL/test_repos/MABL/mabl/train.py"
seeds=(0 1 2 3)
# alg="cmbm"
# alg2="maser"
# seed=0
...
# notsm=False
nworkers=2
envs_mag=(3s_vs_3z 3s_vs_4z 3s_vs_5z 5m_vs_6m 8m_vs_9m 2c_vs_64zg MMM MMM2 so_many_baneling)
envs_over24=(2c_vs_64zg so_many_baneling 27m_vs_30m)
envs_l=(8m_vs_9m MMM MMM2 so_many_baneling)
...
do
 for s in "${seeds[@]}"
 do
    sbatch run2.sh ${mainPy} ${e} ${nworkers}
 done
done
